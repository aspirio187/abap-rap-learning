CLASS zcl_rap100_gen_data_sh DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_sh IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'sh',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap_atravsh.
    DELETE FROM zrap_atravsh.

    "insert travel demo data
    INSERT zrap_atravsh  FROM (
        SELECT
